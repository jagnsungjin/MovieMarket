...
private DataSource ds;
	...
	public int bkInsert(Bbs_bk_bean bbs_bkbean) {
		...
		try {
			...
			pstmt.setString(2, bbs_bkbean.getBK_CSFC());
			...
			pstmt.setString(5, bbs_bkbean.getUSER_ID());
	...
	public int bbs_bkSearchListCount(String searchType , String search) {
	   ...
	   public List<Bbs_bk_bean> getBoardEnrList(int page, int limit) {
		      ...
		      try {
		         ...
		         ex.printStackTrace();
		         System.out.println("getBoardEnrList() 에러 : " + ex);
		      }finally {
		         if(rs !=null)
		            try {
		               rs.close();
	   ...
	   public List<Bbs_bk_bean> getBoardReaList(int page, int limit) {
		      ...
		      try {
		         ...
		         ex.printStackTrace();
		         System.out.println("getBoardReaList() 에러 : " + ex);
		      }finally {
		         if(rs !=null)
		            try {
		               rs.close();
