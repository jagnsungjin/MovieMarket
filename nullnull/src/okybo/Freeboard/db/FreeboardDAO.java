...
public class FreeboardDAO {
	...
	//게시판 검색
	public List<FreeboardBean> getFrBoardSearchList(int page, int limit, String searchType, String search, String view, String category) {
	...
	//게시판 검색 2
	public int getFrSearchListCount(String searchType, String search, String category) {
		Connection conn= null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String searchs="";
		...
		try {
			...
			if (category == null) {
				sql = "select count(*) from BBS_FR where "+searchs+"";				
			} else {
				sql = "select count(*) from BBS_FR where fr_csfc=? and "+searchs+"";								
			}
