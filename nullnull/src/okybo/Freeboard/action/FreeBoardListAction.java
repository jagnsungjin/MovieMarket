...
public class FreeBoardListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		if(searchType=="" && search=="") { //일반리스트
			...
			boardlist = boarddao.getFrBoardSearchList(page, limit, searchType, search, view, category);
			listcount = boarddao.getFrSearchListCount(searchType, search, category);
	    ...
	    // 현재 페이지에 표시할 끝 페이지 수재욱님 제가봣을떈 왠지 이거같은데 이게 어딘지 모르겟네요 아니면 일단 되는 소스로 제출하고 
		// 제가 찾아보겠습니다 ! 
