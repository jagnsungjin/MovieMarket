...
public class RvBean {
	...
	private String RV_CSFC;
	private String RV_GRADE;
	
	
	
	public String getRV_GRADE() {
		return RV_GRADE;
	}
	public void setRV_GRADE(String rV_GRADE) {
		RV_GRADE = rV_GRADE;
	}
	public String getRV_CSFC() {
		return RV_CSFC;
	}
	public void setRV_CSFC(String rV_CSFC) {
		RV_CSFC = rV_CSFC;
	}
	public int getRV_NO() {
		return RV_NO;
