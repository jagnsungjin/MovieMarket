...
<%
    ...
    String content="회원 아이디: "  + request.getParameter("userid") +"<br>" 
	...
	*/
	...
	try{
		...
		//제목 정보를 설정합니다.
		message.setSubject(request.getParameter("userid") +" 님으로 부터 문의메일입니다.");
		...
		out.println("<script>alert('메일이 정상적으로 전송되었습니다.');");
