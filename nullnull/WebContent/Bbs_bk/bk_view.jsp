...
<script src="js/fr_js/cookie.js"></script>  
   <script src="js/bk_js/view.js"></script>
<script>
      $(function(){ 
         var id = '${id}';
      ...
      $("#all").click(function(){
       ...
       $("#cate5").click(function(){
          location.href="FrList5.okybo";
			...
			location.href = "Bbs_bkReplyView.bk?num=${boarddata.BK_NO}"
		})
		$("#updateB").click(function() {
			location.href = "Bbs_bkModifyView.bk?num=${boarddata.BK_NO}"
		})
			...
			<div class="ctg">
				<div class="categories">
					...
					<ul class="categories__menu">
						...
						<li><a href="NTList.bo">공지사항</a></li>
						<li><a href="RvList.rv">영화후기</a></li>
						<li><a href="movieticketing.mo"><b>영화예매</b></a></li>
	...
	<section class="notice">
		...
		<div id="board-list">
			<div class="container">
				...
				<h3>
					<b>분류 :  &nbsp;${Bbs_bkdata.BK_CSFC}</b><br>
				</h3>
				<hr>
				
				<h4><b>가격 : &nbsp;${Bbs_bkdata.BK_PRICE}원<span></span></b> </h4>
					...
					<thead>
						...
						<tr id="tableheader">
							<td scope="col" class="th-num" colspan=2><b>첨부파일</b>&nbsp; <c:if
									test="${!empty Bbs_bkdata.BK_FILE}">
									<%--파일첨부한 경우 --%>
									<img src="image/down.png" width="10px">
									<a href="RvFileDown.rv?filename=${Bbs_bkdata.BK_FILE}">
										${Bbs_bkdata.BK_FILE}</a>
								</c:if> <c:if test="${empty Bbs_bkdata.BK_FILE}">
									<%--파일 첨부하지 않은경우 --%>
									&nbsp;
								</c:if></td>
							<td scope="col" class="th-title" id="ddd"></td>
							<td scope="col" class="th-date"><b>조회수</b> &nbsp;
								${Bbs_bkdata.BK_READ}</td>


						</tr>
						<tr id="Ttextarea">
							<td style="padding-right: 0px" colspan=4><textarea
									class="form-control" rows="15" id="TXT" readonly>${Bbs_bkdata.BK_CONTENT}</textarea></td>
				...
				<div class="btn-wrap">
					...
					<input type="button" id="indexB" class="btn" value="목록">
				</div>
				<%-- modal 시작 --%>
