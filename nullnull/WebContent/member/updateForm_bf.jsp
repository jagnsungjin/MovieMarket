...
body {min-height: 100vh; background:#eceaea; 
	 }
...
-->
<div align="center">
 <a href="http://localhost:8088/nullnull/"><img style="text-align: center; height:70px; width:130px" src="image/logo.png" ></a>
</div>
<div class="container"> 
   <div class="input-form-backgroud row"> 
	 <div class="input-form col-md-12 mx-auto">
	   <h4 class="mb-3">회원 정보 수정</h4>
	    <form class="validation-form" novalidate name="joinform" action="updateProcess.oky"
	     method="post" enctype="multipart/form-data">
	     <div class="row"> 
	      <div class="col-md-12 mb-3">
	       <label for="id">아이디</label>
	        <input type="text" class="form-control" name="id" value="${memberinfo.id}" readOnly>
	      </div>
	     </div>
	     ...
	     <div class="row">
	      <div class="col-md-12 mb-3">
	       <label for="pass">비밀번호</label>
	        <input type="password" class="form-control" id="pass" name="pass" value="${memberinfo.pass}" readOnly>
	      </div> 
	     </div>
	     ...
	     <div class="row">
	      <div class="col-md-12 mb-3">
	       ...
	       <input type="text" class="form-control" name="name" id="name"
	       		  value="${memberinfo.name}" placeholder="이름을 입력하세요" required>
	      </div> 
	     </div>
	     ...
	     <div class="row">
	      <div class="col-md-12 mb-3">
	       ...
	       <input type="text" class="form-control" name="birth" id="birth"
	       		  value="${memberinfo.birth}" placeholder="생년월일 8자를 입력하세요">
	      </div> 
	     </div>
	      ...
	      <div class="row">
	       <div class="col-md-12 mb-3">
	        ...
	        <input type="text" size="11"  class="form-control" maxLength="11" placeholder="01012345678"
	           	   name="phone" id="phone" value="${memberinfo.phone}">
	       </div>
	      </div>
	       ...
	       <div class="col-md-12 mb-3">
	        ...
	        <input type="text" size="11"  class="form-control" placeholder="이메일을 입력하세요"
	           	   name="email" id="email" value="${memberinfo.email}" required>
	       </div>
	      </div>
