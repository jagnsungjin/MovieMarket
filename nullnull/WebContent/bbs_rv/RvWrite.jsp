	...
	<form action ="RvAddAction.rv" method = "post" enctype="multipart/form-data"
		...
		<div class="form-group">
			<label for="RV_PASS">비밀번호<span>*</span></label> <input type="password"
				name="RV_PASS" id ="RV_PASS" maxlength="30"
				placeholder="비밀번호를 입력하세요. . .">
		</div>

		<div class="form-group">
			<label >영화제목</label><br>
			<select name="RV_CSFC" id="RV_CSFC" >
				<option value="인질" selected>인질</option>
				<option value="싱크홀">싱크홀</option>
				<option value="모가디슈">모가디슈</option>
				<option value="올드">올드</option>
				<option value="프리 가이">프리 가이</option>
				<option value="퍼피 구조대 더 무비">퍼피 구조대 더 무비</option>
				<option value="남색대문">남색대문</option>
