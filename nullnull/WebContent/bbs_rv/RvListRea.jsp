...
<script src="js/fr_js/cookie.js"></script>
 <script src="js/rv_js/list.js"></script>
               ...
               <form  method="get" action="RvList.rv" name="search">
                  <div class="search-wrap">
                     ...
                     <br> <select name="searchType" id="searchType">
                        <option value="submov"
                           ${(searchType =="submov")? "selected" : ""}>영화제목</option>
                        <option value="subAcon"
                           ${(searchType =="subAcon")? "selected" : ""}>제목+내용</option>
                        <option value="subject"
                           ${(searchType =="subject")? "selected" : ""}>제목</option>
                        <option value="content"
                           ${(searchType =="content")? "selected" : ""}>내용</option>
                        <option value="writer"
                           ${(searchType =="writer")? "selected" : ""}>글쓴이</option>
                     </select>
                     <div class="btn-wrap">
         ...
         <div class="container">
            <table class="board-table">
               <thead>
                  <tr>
                     ...
                     <th scope="col" class="th-title">평점</th>
               ...
               <tbody>
                  ...
                  <c:forEach var="b" items="${boardlist}">
                     <tr>
                        ...
                        <td><b>${b.RV_CSFC}</b></td>
                        <td><b>${b.RV_GRADE}점</b><span id ="star">★</span></td>
                        <th>
                           
                           <%--제목 --%>
                           <div>

                              <c:if test="${b.RV_RE_LEV != 0}">
                                 <!--  답글인 경우 -->
                              ...
                              <a href="RvDetailAction.rv?num=${b.RV_NO}"> <c:out
                                    value="${b.RV_SUBJECT}" /> <%-- ${b.board_subject} --%> <%-- escapeXml="true" : HTML 태그를 화면에 그대로 보여줍니다. --%>
                              </a>
                           </div>
                        </th>
            ...
            <div class="center-block">
               <ul class="pagination justify-content-center">
                  ...
                  <c:if test="${page > 1 }">
                     <li class="page-item"><a href="RvListRea.rv?page=${page-1}"
                  ...
                  <c:forEach var="a" begin="${startpage}" end="${endpage}">
                     ...
                     <c:if test="${a != page }">
                        <li class="page-item"><a href="RvListRea.rv?page=${a}"
