		...
		<div class="movie_form">
			<div class="info_movie">
				...
				<p style="text-align: center">
					...
					<img style="text-align: center; width: 150px; height: 200px;"
						src="movie.jpeg">

				</p>
				<div class="movieinfo">
					<ul>
						<li><span style="font-size: 15px">영화 이름 : 블랙위도우</span> <span
							id="moviename"></span></li>
						<li><span>영화 장소 : cgv</span> <span id="movieplace"></span></li>
						<li><span>영화 날짜 : 2020-555-55</span> <span id="moviedate"></span>
						</li>
						<li><span>시간 : 5시20분</span> <span id="movietime"></span></li>
						<li><span>인원 :2명</span> <span id="moviepeoples"></span></li>
					</ul>
				</div>
